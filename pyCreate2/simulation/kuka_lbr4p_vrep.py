...
class KukaLBR4PlusVrep:
    ...
    def close_gripper(self):
        vrep.simxSetIntegerSignal(
            self._clientID, 'P_Grip_straight_motor', 1, vrep.simx_opmode_oneshot_wait)

    def open_gripper(self):
        vrep.simxSetIntegerSignal(
            self._clientID, 'P_Grip_straight_motor', 0, vrep.simx_opmode_oneshot_wait)
    ...
    def enable_painting(self):
        ...
        """
        vrep.simxSetIntegerSignal(
            self._clientID, "paintingEnabled", 1, vrep.simx_opmode_oneshot_wait)

    def disable_painting(self):
        """Disable spray painting end-effector.
        """
        vrep.simxSetIntegerSignal(
            self._clientID, "paintingEnabled", 0, vrep.simx_opmode_oneshot_wait)
    ...
    def set_color(self, r, g, b):
        ...
        vrep.simxSetFloatSignal(
            self._clientID, "paintingColorR", r, vrep.simx_opmode_oneshot_wait)
        vrep.simxSetFloatSignal(
            self._clientID, "paintingColorG", g, vrep.simx_opmode_oneshot_wait)
        vrep.simxSetFloatSignal(
            self._clientID, "paintingColorB", b, vrep.simx_opmode_oneshot_wait)
        vrep.simxSetIntegerSignal(
            self._clientID, "paintingUpdate", 1, vrep.simx_opmode_oneshot_wait)
