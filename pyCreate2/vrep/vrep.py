...
try:
    if platform.system() == 'cli':
        libsimx = ct.CDLL(os.path.join(
            os.path.dirname(__file__), "remoteApi.dll"))
    elif platform.system() == 'Windows':
        libsimx = ct.CDLL(os.path.join(
            os.path.dirname(__file__), "remoteApi.dll"))
    elif platform.system() == 'Darwin':
        libsimx = ct.CDLL(os.path.join(
            os.path.dirname(__file__), "remoteApi.dylib"))
    else:
        if platform.machine().startswith("arm"):
            libsimx = ct.CDLL(os.path.join(
                os.path.dirname(__file__), "remoteApi_arm.so"))
        else:
            libsimx = ct.CDLL(os.path.join(
                os.path.dirname(__file__), "remoteApi.so"))
except:
    print('----------------------------------------------------')
